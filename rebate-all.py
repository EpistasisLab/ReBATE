...
if(algorithm != 'relieff' and algorithm != 'surf' and algorithm != 'surfstar'
                          and algorithm != 'multisurf' and algorithm != 'all'):
...
if(algorithm == 'relieff' or algorithm == 'all'):
    import relieff as R
...
if(algorithm == 'multisurf' or algorithm == 'all'):
    if(var['classType'] == 'multiclass'):
        import mcms as MS
    else:
        import multisurf as MS
...
if(algorithm == 'surf' or algorithm == 'all'):
    import surf as S
...
if(algorithm == 'surfstar' or algorithm == 'all'):
    import surf as S
